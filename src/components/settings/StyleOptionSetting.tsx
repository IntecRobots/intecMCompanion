...
const StyleOptionSetting: React.FC<ThemeOptionProps> = ({
  text,
  onPress,
  isDarkMode,
  center,
  ...
  if (stylesBoton && !(typeof stylesBoton.create === "function"))
    stylesBoton == undefined;
  if (stylesText && !(typeof stylesText.create === "function"))
